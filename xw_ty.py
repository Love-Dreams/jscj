...
class NewsSpider:
    def __init__(self):
        self.start_url = "https://api.jinse.com/v4/information/list/?catelogue_key=capitalmarket&information_id=0&limit=20&flag=down&version=9.9.9"
        self.next_url_temp = "https://api.jinse.com/v4/information/list/?catelogue_key=capitalmarket&information_id={}&limit=20&flag=down&version=9.9.9"
    ...
    def get_detail_page(self,html_list):
        ...
        # print(html)
        item["title"] = html.xpath(".//div[@class='title']/h2/text()")
        print(item["title"])
        print(type( item["title"]))
        # try:
        # item["source"] = html.xpath(".//div[@class='source']/a/text()")
        # if item["source"] == None:
        try:
            item["source"] = html.xpath(".//div[@class='tags']/a/text()")[0]
        except Exception as e:
            item["source"] = '金色财经'
        #     if item["source"] ==None:
        #         item["source"] = html.xpath(".//div[@class='source']//text()")
    ...
    def run(self): #实现主要逻辑
        ...
        for url in xq_list:
            if url == "https://m.jinse.com/atlas/detail_6.html":
                continue
            else:
            # try:
