...
class NewsSpider:
    def __init__(self):
        self.start_url = "https://api.jinse.com/v4/information/list/?catelogue_key=zhengce&information_id=0&limit=20&flag=down&version=9.9.9"
        self.next_url_temp = "https://api.jinse.com/v4/information/list/?catelogue_key=zhengce&information_id={}&limit=20&flag=down&version=9.9.9"
    ...
    def update(self,data):
        ...
        try:
            ...
            # 执行Mysql语句， 得到数据库变化值
            ret = cur.execute(sql,[item["title"],item["source"], item["writer"], item["keyword"], item["time"],item["time"], item['thumbnail'], column])
